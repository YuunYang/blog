...
from [https://www.jianshu.com](https://www.jianshu.com/p/dc3bceb10dbb)
```html
<!DOCTYPE html>
<html>
  <head>
...
### 盒模型
盒模型分为标准模型、IE模型
![box-normal][box-01]{: .align-center}

box-sizing:content-box;
在标准模型中，盒模型的宽高只是content的宽高。
![box-IE][box-02]{: .align-center}
...
from [https://medium.com/@shoshanarosenfield](https://medium.com/@shoshanarosenfield/redux-thunk-vs-redux-saga-93fe82878b2d)
...
from [https://www.cnblogs.com/](https://www.cnblogs.com/catch/p/3495450.html)
```javascript
int func(int n)
{
    if (n <= 1) return 1;
